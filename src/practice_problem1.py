...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.volume = volume
        self.extra = ''
        self.start_v = self.volume
        self.start_c = self.contents
        self.history = []
    ...
    def append_string(self, additional_contents):
        ...
        if space > 0:
            self.contents = self.contents + additional_contents[0:space]
            self.extra = additional_contents[space:len(additional_contents)]
            return self.extra
        else:
            self.extra = ''
            return self.extra
    ...
    def shrink(self, new_volume):
        self.shrunk = self.contents[new_volume:self.volume]
    ...
    def double_then_shrink(self, new_volume):
        ...
        return len(self.extra) + len(self.shrunk)
